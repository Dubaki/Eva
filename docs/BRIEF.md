...
- [x] **Phase 5i: UI & Bot Polish** — Бот полностью переведен на `parse_mode: HTML` для стабильности текста, исправлена верстка стартового экрана Mini App (адаптивная картинка, отсутствие скролла, улучшенные отступы) (09.04.2026).
