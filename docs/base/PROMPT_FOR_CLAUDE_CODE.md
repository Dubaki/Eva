...
3. **`design_reference.html`** (в папке docs\base) — приложенный мной HTML-файл с эталонным дизайном всех страниц. **Главный источник правды по визуалу.**

Эти три файла — закон.

Дополнительно в  папке docs\base лежат:
