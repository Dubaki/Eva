  ...
  return (
    <header className="fixed top-0 left-0 right-0 z-50 h-16 flex items-center justify-between px-container-padding bg-surface/80 backdrop-blur-lg border-b border-outline/10">
      <div className="flex items-center gap-2">
        ...
        <span className="font-headline-md italic text-xl text-primary tracking-tight">EVA</span>
      </div>
      <div className="flex items-center">
        <button className="w-10 h-10 rounded-full flex items-center justify-center text-on-surface/70 hover:bg-surface-variant transition-colors active:scale-90 duration-200">
